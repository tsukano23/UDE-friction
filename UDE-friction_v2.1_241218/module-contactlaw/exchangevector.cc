...
exchangevector::inner(Vec3 a, Vec3 b) const
{
	...
	doublereal r_inner 	= ax * bx + ay * by + az * bz;
...
void 
exchangevector::normal_vec(Vec3& normal_vec) const
{
...
void
exchangevector::lateral_vec(Vec3& lateral_unitvec, Vec3& normal_vec, Vec3& internode_unitvec, const Vec3& r1, const Vec3& r2) const
{
...
void
exchangevector::axial_vec(Vec3& axial_unitvec, Vec3& normal_vec, Vec3& lateral_unitvec, const Vec3& r1, const Vec3& r2) const
{
